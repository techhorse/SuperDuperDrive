package com.personal.superduperdrive;

import com.personal.superduperdrive.page.HomePage;
import com.personal.superduperdrive.page.LoginPage;
import com.personal.superduperdrive.page.ResultPage;
import com.personal.superduperdrive.page.SignupPage;
...
public class CredentialUploadTest {
    ...
    public void editCredentialTest() throws InterruptedException {
        ...
        homePage.editCredential("website.com", "abhi", "admin321");
        ...
        assertEquals("abhi", homePage.getCredentialUsernameTextValue());
    }
